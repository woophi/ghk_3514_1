...
const whatElses = [
  {
    ...
    analytics: 'Margin_credit_3514_click_var1',
  },
  {
    title: 'Тарифы',
    subtitle: 'Сделки РЕПО и СВОП',
    link: null,
    analytics: 'Tarifs_3514_click_var1',
  },
  {
    ...
    analytics: 'Required_security_3514_click_var1',
  },
  {
    ...
    analytics: 'Safety_3514_click_var1',
  },
];
    ...
    <>
      <div className={appSt.container}>
        ...
        <div>
          ...
          <div className={appSt.box}>
            ...
            <Swiper spaceBetween={16} slidesPerView="auto" style={{ width: '100%' }}>
              {swiperData.map((slide, index) => (
                <SwiperSlide
                  ...
                  key={slide.link}
                  onClick={() => {
                    window.gtag('event', `Lesson_${index + 1}_3514_click_var1`);
            ...
            <ButtonMobile
              ...
              view="primary"
              onClick={() => {
                window.gtag('event', 'Test_3514_click_var1');
        ...
        <div
          ...
          onClick={() => {
            window.gtag('event', 'Articles_3514_click_var1');
            setOpenBs(true);
          }}
        >
          <Typography.TitleResponsive tag="h2" view="small" font="system" weight="semibold">
        ...
        <div className={appSt.boxExpanded({ expanded })}>
          <div
            className={appSt.boxRow}
            onClick={() => {
              window.gtag('event', 'What_else_3514_click_var1');
      ...
      <div className={appSt.containerBottom}>
        ...
        <div className={appSt.bottomRow} onClick={() => window.gtag('event', 'MTS_Bank_3514_click_var1')}>
        ...
        <div className={appSt.bottomRow} onClick={() => window.gtag('event', 'MTS_3514_click_var1')}>
        ...
        <div className={appSt.bottomRow} onClick={() => window.gtag('event', 'SBER_3514_click_var1')}>
      ...
      <div className={appSt.container}>
        <ButtonMobile
          ...
          onClick={() => window.gtag('event', 'Terminal_3514_click_var1')}
        >
          Перейти в терминал
        </ButtonMobile>
      </div>
        ...
        <div className={appSt.containerBS}>
          {articles.map((article, index) => (
            <div
              ...
              onClick={() => {
                window.gtag('event', `Arcticles_${index + 1}_3514_click_var1`);
      ...
      >
        <div className={appSt.containerBS}>
          ...
          <div
            ...
            onClick={() => {
              window.gtag('event', 'Repo_3514_click_var1');
          ...
          <div
            className={appSt.slideRow}
            onClick={() => {
              window.gtag('event', 'Swap_3514_click_var1');
